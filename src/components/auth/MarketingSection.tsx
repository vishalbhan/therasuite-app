...
export function MarketingSection() {
  return (
    <div className="h-screen flex flex-col justify-center p-8 bg-gradient-to-b from-violet-50 to-violet-100">
      <div className="max-w-xl mx-auto">
        <h1 className="text-3xl font-bold text-violet-900 mb-3">
          Transform Your Therapy Practice
        </h1>
        <p className="text-base text-violet-700 mb-10">
          ...
          {features.map((feature) => {
            ...
            return (
              <div key={feature.title} className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm text-violet-900 mb-0.5">
                    {feature.title}
                  </h3>
